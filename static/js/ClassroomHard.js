class ClassroomHard extends Phaser.Scene{
    ...
    init(data){
        ...
        this.topicSelection();//reinitialize just in case
    }
    ...
    create(){
        ...
        //reinitialize fetchQuestions as cannot be passed over from previous scene
    ...
    showDialogBox() {
        ...
        if(this.responseFlag){
            ...
            console.log("Selected Category in new Question : ",selectedCategory);
            console.log("Question Bank when after selecting",this.questionBank[selectedTopic][selectedCategory]);
        ...
        element.addEventListener('keydown', event => {
            if (event.key === 'Enter') {
                ...
                if (userPasscode === this.passcodeNumbers.join('')) {
                    ...
                    this.scene.start('LoungeHard',{hintRemaining : this.hintRemaining, lifePointsValue : life_remain});
                } else {
                    // Incorrect passcode
