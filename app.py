...
def chatgpt_prompt():
    ...
    augment = "Explain how to solve the following math problem step-by-step. After explaining the original problem, provide a different, similar example and show how to solve it. Use simple language appropriate for Year 9 to 11 IGCSE students and include definitions or tips if needed. Show your chain-of-thought so that the explanation is clear and logical. Dont have to bold or italic the response."
